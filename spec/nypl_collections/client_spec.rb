...
describe Collections::Client do
  ...
  describe '#return_captures_for_uuid' do
    before do
      stub_request(:get, "http://api.repo.nypl.org/api/v1/items/5fa75050-c6c7-012f-e24b-58d385a7bc34?withTitles=yes").
    ...
    it "fetches the first ten results" do
      results = @client.return_captures_for_uuid('5fa75050-c6c7-012f-e24b-58d385a7bc34', withTitles: 'yes')
      results = JSON.parse(results.body)
      expect(a_request(:get, "http://api.repo.nypl.org/api/v1/items/5fa75050-c6c7-012f-e24b-58d385a7bc34?withTitles=yes").
         with(:headers => {'Authorization'=>'Token token=abc123'})).
         to have_been_made
